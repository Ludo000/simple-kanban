...
import { KanbanColumnComponent } from 'app/entities/kanban-column/kanban-column.component';
...
describe('Component Tests', () => {
  describe('KanbanColumn Management Component', () => {
    let comp: KanbanColumnComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(KanbanColumnComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.kanbanColumns && comp.kanbanColumns[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
