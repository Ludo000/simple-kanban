...
import { KanbanTableComponent } from 'app/entities/kanban-table/kanban-table.component';
...
describe('Component Tests', () => {
  describe('KanbanTable Management Component', () => {
    let comp: KanbanTableComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(KanbanTableComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.kanbanTables && comp.kanbanTables[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
