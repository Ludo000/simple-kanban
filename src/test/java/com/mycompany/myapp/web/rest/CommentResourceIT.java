...
public class CommentResourceIT {
    ...
    public void createComment() throws Exception {
        ...
        assertThat(testComment.getModificationDate()).isEqualTo(DEFAULT_MODIFICATION_DATE);
    }
    ...
    public void updateComment() throws Exception {
        ...
        assertThat(testComment.getModificationDate()).isEqualTo(UPDATED_MODIFICATION_DATE);
    }
