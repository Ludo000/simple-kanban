...
export class HistoryComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.historyService
      ...
      .subscribe(
        (res: HttpResponse<IHistory[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInHistories(): void {
    this.eventSubscriber = this.eventManager.subscribe('historyListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IHistory[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
